public class ShopTest {
    public static void main(String[] args) {
        ...
        Product tooll = new Product( "Mlotek", 25, "mlotek 5 kg", category1);
        ...
        SpecialOffer offer1 = new SpecialOffer(tooll, "przecena 25%", "25-06-2019", "01-08-2019", 0.25);

        tooll.showProduct();
        kitchen1.showProduct();
